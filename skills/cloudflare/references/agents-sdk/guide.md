# Agents SDK — full guide

> Consolidated into the `cloudflare` skill from the former standalone `agents-sdk` skill (2026-07-25). Original archived at `~/.claude/skills-archive/agents-sdk/`.
